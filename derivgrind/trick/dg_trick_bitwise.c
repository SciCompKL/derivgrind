/*--------------------------------------------------------------------*/
/*--- Bit-trick-finder handling of              dg_trick_bitwise.c ---*/
 ...
 *  in the file dg_trick_operations.c generated by gen_operationhandling_code.py. 
...
// the shared state.
static V128 dg_trick_bitwise_out;
VG_REGPARM(0) ULong dg_trick_bitwise_get_lower(void){
  return *(ULong*)&dg_trick_bitwise_out;
}
...
#define DG_HANDLE_HALVES(fun32) \
  { \
    ...
    V128 out_tmp = dg_trick_bitwise_out; \
    fun32(x_u.u32.u32_1, xiLo_u.u32.u32_1, xiHi_u.u32.u32_1, y_u.u32.u32_1, yiLo_u.u32.u32_1, yiHi_u.u32.u32_1); \
    dg_trick_bitwise_out.w32[1] = out_tmp.w32[0]; \
    dg_trick_bitwise_out.w32[3] = out_tmp.w32[2]; \
  }
 ...
 *
 *  The result is 
 *   - active if the floating-point operand is active, and
 *   - not discrete.
 */
...
VG_REGPARM(0) void dg_trick_bitwise_and64(ULong x, ULong xiLo, ULong xiHi, ULong y, ULong yiLo, ULong yiHi){
  DG_HANDLE_AND((&dg_trick_bitwise_out), double,ULong, x, y)
  else DG_HANDLE_AND((&dg_trick_bitwise_out), double,ULong, y, x)
  else DG_HANDLE_HALVES(dg_trick_bitwise_and32)
}

/*--- OR <-> negative abs ---*/
// compare with 0b100...0 and 0b00...0
// the "constant" operand should not be active, but it may be discrete or not
...
VG_REGPARM(0) void dg_trick_bitwise_or64(ULong x, ULong xiLo, ULong xiHi, ULong y, ULong yiLo, ULong yiHi){
  DG_HANDLE_OR((&dg_trick_bitwise_out), double,ULong, x, y)
  else DG_HANDLE_OR((&dg_trick_bitwise_out), double,ULong, y, x)
  else DG_HANDLE_HALVES(dg_trick_bitwise_or32)
}
...
VG_REGPARM(0) void dg_trick_bitwise_xor64(ULong x, ULong xiLo, ULong xiHi, ULong y, ULong yiLo, ULong yiHi){
  DG_HANDLE_XOR((&dg_trick_bitwise_out), double,ULong, x, y)
  else DG_HANDLE_XOR((&dg_trick_bitwise_out), double,ULong, y, x)
  else DG_HANDLE_HALVES(dg_trick_bitwise_xor32)
}
