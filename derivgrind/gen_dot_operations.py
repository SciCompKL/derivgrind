...
for Op, op in [("And","and"), ("Or","or"), ("Xor","xor")]:
  ...
  for (simdsize,fpsize) in [(1,4),(1,8),(2,8),(4,8)]:
    ...
    the_op.barcode = applyComponentwisely({"arg1":"arg1_part","i1Lo":"i1Lo_part","i1Hi":"i1Hi_part","arg2":"arg2_part","i2Lo":"i2Lo_part","i2Hi":"i2Hi_part"}, {"indexLo":"indexLo_part","indexHi":"indexHi_part"}, fpsize, simdsize, f'IRTemp t = newIRTemp(diffenv->sb_out->tyenv, Ity_I64);\n  IRDirty* di = unsafeIRDirty_1_N( t, 0, "dg_bar_bitwise_{op}64", &dg_bar_bitwise_{op}64, mkIRExprVec_6(arg1_part, i1Lo_part, i1Hi_part, arg2_part, i2Lo_part, i2Hi_part));  \n addStmtToIRSB(diffenv->sb_out, IRStmt_Dirty(di));\n      IRExpr* indexInt_part = IRExpr_RdTmp(t); \nIRExpr* indexLo_part = IRExpr_Binop(Iop_32HLto64, IRExpr_Const(IRConst_U32(0)), IRExpr_Unop(Iop_64to32, indexInt_part));\nIRExpr* indexHi_part = IRExpr_Binop(Iop_32HLto64, IRExpr_Const(IRConst_U32(0)), IRExpr_Unop(Iop_64HIto32, indexInt_part)); ') 
