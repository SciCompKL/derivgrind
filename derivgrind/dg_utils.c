...
IRExpr* isZero(IRExpr* expr, IRType type){
  switch(type){
    ...
    //case Ity_I128: return IRExpr_Binop(Iop_CmpEQ128,expr,IRExpr_Const(IRConst_U8(0)));
    ...
    //case Ity_F128: return IRExpr_Binop(Iop_CmpEQ128,IRExpr_Unop(Iop_ReinterpF128asI128,expr),IRExpr_Const(IRConst_U128(0)));
  }
}
