...
functions = [
  ...
  DERIVGRIND_MATH_FUNCTION("exp2", "exp2(x)*log(2.)","double"),
  DERIVGRIND_MATH_FUNCTION("expm1", "exp(x)","double"),
  DERIVGRIND_MATH_FUNCTION("fabs", "(x>0.?1.:-1.)","double"),
  DERIVGRIND_MATH_FUNCTION("floor", "0.","double"),
  DERIVGRIND_MATH_FUNCTION("trunc", "0.","double"),
  DERIVGRIND_MATH_FUNCTION("round", "0.","double"),
  DERIVGRIND_MATH_FUNCTION("nearbyint", "0.","double"),
  DERIVGRIND_MATH_FUNCTION("rint", "0.","double"),
  DERIVGRIND_MATH_FUNCTION("log","1./x","double"),
  DERIVGRIND_MATH_FUNCTION("log2", "1./(log(2.)*x)","double"),
  DERIVGRIND_MATH_FUNCTION("log10", "1./(log(10.)*x)","double"),
  DERIVGRIND_MATH_FUNCTION("log1p","1./(1.+x)","double"),
  ...
  DERIVGRIND_MATH_FUNCTION("cbrt", "cbrt(x)/(3.*x)","double"),
  DERIVGRIND_MATH_FUNCTION2("hypot","x/hypot(x,y)","y/hypot(x,y)","double"),
  ...
  DERIVGRIND_MATH_FUNCTION("exp2f", "exp2f(x)*logf(2.f)","float"),
  DERIVGRIND_MATH_FUNCTION("expm1f", "expf(x)","float"),
  DERIVGRIND_MATH_FUNCTION("fabsf", "(x>0.f?1.f:-1.f)","float"),
  DERIVGRIND_MATH_FUNCTION("floorf", "0.f","float"),
  DERIVGRIND_MATH_FUNCTION("truncf", "0.f","float"),
  DERIVGRIND_MATH_FUNCTION("roundf", "0.f","float"),
  DERIVGRIND_MATH_FUNCTION("nearbyintf", "0.f","float"),
  DERIVGRIND_MATH_FUNCTION("rintf", "0.f","float"),
  DERIVGRIND_MATH_FUNCTION("logf","1.f/x","float"),
  DERIVGRIND_MATH_FUNCTION("log2f", "1.f/(logf(2.f)*x)","float"),
  DERIVGRIND_MATH_FUNCTION("log10f", "1.f/(logf(10.f)*x)","float"),
  DERIVGRIND_MATH_FUNCTION("log1pf","1.f/(1.f+x)","float"),
  ...
  DERIVGRIND_MATH_FUNCTION("cbrtf", "cbrtf(x)/(3.f*x)","float"),
  DERIVGRIND_MATH_FUNCTION2("hypotf","x/hypotf(x,y)","y/hypotf(x,y)","float"),
  ...
  DERIVGRIND_MATH_FUNCTION("exp2l", "exp2l(x)*logl(2.l)","long double"),
  DERIVGRIND_MATH_FUNCTION("expm1l", "expl(x)","long double"),
  DERIVGRIND_MATH_FUNCTION("fabsl", "(x>0.l?1.l:-1.l)","long double"),
  DERIVGRIND_MATH_FUNCTION("floorl", "0.l","long double"),
  DERIVGRIND_MATH_FUNCTION("truncl", "0.l","long double"),
  DERIVGRIND_MATH_FUNCTION("roundl", "0.l","long double"),
  DERIVGRIND_MATH_FUNCTION("nearbyintl", "0.l","long double"),
  DERIVGRIND_MATH_FUNCTION("rintl", "0.l","long double"),
  DERIVGRIND_MATH_FUNCTION("logl","1.l/x","long double"),
  DERIVGRIND_MATH_FUNCTION("log2l", "1.l/(logl(2.l)*x)","long double"),
  DERIVGRIND_MATH_FUNCTION("log10l", "1.l/(logl(10.l)*x)","long double"),
  DERIVGRIND_MATH_FUNCTION("log1pl", "1.l/(1.l+x)","long double"),
  ...
  DERIVGRIND_MATH_FUNCTION("cbrtl", "cbrtl(x)/(3.l*x)","long double"),
  DERIVGRIND_MATH_FUNCTION2("hypotl","x/hypotl(x,y)","y/hypotl(x,y)","long double"),
